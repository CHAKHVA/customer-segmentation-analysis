...
def plot_distribution(
    ...
    plt.hist(
        data[column], bins=bins, color=color, alpha=0.7, edgecolor="black", density=True
    )
...
def plot_boxplot(
    ...
    plt.suptitle(
        title or "Box Plots of Numerical Features",
        fontsize=14,
        fontweight="bold",
        y=1.02,
    )
...
def plot_scatter(
    ...
    if hue:
        ...
        sns.scatterplot(
            data=data, x=x_col, y=y_col, s=100, alpha=0.7, color="steelblue"
        )
...
def plot_pairplot(
    ...
    pairplot.fig.suptitle(
        "Pairplot of Numerical Features", y=1.02, fontsize=14, fontweight="bold"
    )
...
def plot_multiple_distributions(
    ...
    for idx, col in enumerate(columns):
        axes[idx].hist(
            data[col], bins=30, color="skyblue", alpha=0.7, edgecolor="black"
        )
    ...
    plt.suptitle(
        title or "Distribution of Numerical Features",
        fontsize=14,
        fontweight="bold",
        y=1.00,
    )
